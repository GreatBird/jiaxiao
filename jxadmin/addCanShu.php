			    ...
			    <div class="col-lg-12">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>添加参数配置</strong></h2>
			            </div>
						<div class="panel-body">
							<form action="../addPeiZhi.php" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="studentTimeMax" class="form-control" placeholder="Text">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="teacherTimeMax" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="preSignTime" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="lukaoPrice" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
