			    ...
			    <div class="col-lg-12">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>添加学员（以下都是必填项目）</strong></h2>
			            </div>
						<div class="panel-body">
							<form action="../addUser.php" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">学员姓名</label>
				                    <div class="col-md-9">
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">学员编号</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="studentID" class="form-control" placeholder="Text" value=<?php echo $studentID;?>>
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">性别</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="sex" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">身份证号</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="cityID" class="form-control" placeholder="Text" >
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">授课类型</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="pattern" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="address" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="phone" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">期号</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="qihao" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">车型</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="carType" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">阶段</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="stage" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				               <!--  <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">工作日价格</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="normalPrice" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">周末价格</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="weekPrice" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div> -->

				                <!-- <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">取消时间限制</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="cancelTimeMax" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div> -->
