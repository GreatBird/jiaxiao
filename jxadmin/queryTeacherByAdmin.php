...
echo " <tr >";
                  ...
                  echo "<td>".$process_date."</td>";
                                        ...
                                        if ($lukaoStatus==0) {
                                          # code...
                                         echo "<td><a href=\"updateLuKaoStatus.php?id=$id\">".'点击设为路训教练'."</td>";

                                         echo "<td>".'已是项训教练'."</td>";
                                         echo "<td><a href=\"updateLuKaoStatusKX.php?id=$id\">".'点击设为空闲'."</td>";
                                        }elseif ($lukaoStatus==1){
                                          echo "<td>".'已是路考教练'."</td>";
                                          echo "<td><a href=\"updateXiangXunStatus.php?id=$id\">".'点击设为项训教练'."</td>";
                                          echo "<td><a href=\"updateLuKaoStatusKX.php?id=$id\">".'点击设为空闲'."</td>";
                                        }else{
                                            echo "<td><a href=\"updateLuKaoStatus.php?id=$id\">".'点击设为路训教练'."</td>";
                                            echo "<td><a href=\"updateXiangXunStatus.php?id=$id\">".'点击设为项训教练'."</td>";
                                        ...
                                        echo "<td><a href=\"deleteTeacher.php?id=$id\">".'删除无效教练'."</td>";
