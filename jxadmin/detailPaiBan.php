				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-table red"></i><span class="break"></span><strong>查看<?php echo $teacherName;?>教练的详细排班</strong></h2>
						...
						<div class="panel-body">
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  ...
							  <?php 
								            ...
								            $sql="SELECT * from paiban where teacherName='$teacherName' and month='$month' and paibanDate='$paibanDate' order by beginTime asc ";
										    ...
										    if ($result) {
										             while($row = mysqli_fetch_array($result))
										                { 
										                    ...
										                    if (intval($lukaoStatus)==1) {
										                    	$finalLKS='路考排班';
										                    }elseif (intval($lukaoStatus)==0) {
										                    	# code...
										                    	$finalLKS='项训排班';
										                    }
										...
										<a class=\"btn btn-info\" href=\"updatePaiBanFinal.php?teacherName=".$teacherName."&month=".$month."&paibanDate=".$paibanDate."&beginTime=".$beginTime."&endTime=".$endTime."\">
									...
									echo "<td>
										...
										<a class=\"btn btn-info\" href=\"deleteCouple.php?id=".$id."\">
											<i class=\"fa fa-edit \"></i>                                            
										</a>
 ...
 -->
			...
			<div class="row">		
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-table red"></i><span class="break"></span><strong>查看<?php echo $teacherName;?>教练的预约</strong></h2>
						...
						<div class="panel-body">
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  ...
							  <?php 
								            ...
								            $sql="SELECT * from yuyue where teacherName='$teacherName' and adminStatus=0 and month='$month' and paibanDate='$paibanDate' order by id asc ";
                                        ...
                                        if ($classStatus==0) {
                                          ...
                                          # code...
										                    ...
										                    echo "<td>".$beginTime."</td>";
										                    echo "<td>".$endTime."</td>";
										                    echo "<td>".$finalType."</td>";
										                    echo "<td>".$classStatusFinal."</td>";


										                    echo "<td>
										
										<a class=\"btn btn-info\" href=\"updateYuYueAdminStatus.php?id=".$id."\">
											<i class=\"fa fa-edit \"></i>                                            
										</a>
