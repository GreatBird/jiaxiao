        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h2><i class="fa fa-table red"></i><span class="break"></span><strong>查看所有电话预约（根据时间倒序）</strong></h2>
...
<!--                   <th>修改信息</th>
 -->
                ...
                <?php 
                            ...
                            $sql="SELECT * from yuyue where phoneYuYue=1 order by id desc";
                            $studentName="";
                            $studentPhone="";
                            $teacherName="";
                            $teacherPhone="";
