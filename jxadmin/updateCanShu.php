		    ...
		    if ($result) {
		             while($row = mysqli_fetch_array($result))
		                { 
		                    ...
		                    $id=$row['id'];
		                    $studentTimeMax=$row['studentTimeMax'];
		                    $teacherTimeMax=$row['teacherTimeMax'];
		                    $preSignTime=$row['preSignTime'];
		                    $normalPrice=$row['normalPrice'];
		                    $weekPrice=$row['weekPrice'];
		                    $lukaoPrice=$row['lukaoPrice'];
		                    $cancelTimeMax=$row['cancelTimeMax'];
			    ...
			    <div class="col-lg-12">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>更改参数配置</strong></h2>
			            </div>
						<div class="panel-body">
							<form action="../updatePeiZhi.php" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">学员单日上限</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="studentTimeMax" class="form-control" placeholder="Text" value=<?php echo $studentTimeMax;?>>
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">教练单日上限</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="teacherTimeMax" class="form-control" placeholder="Text" value=<?php echo $teacherTimeMax;?>>
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">提前签到时间</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="preSignTime" class="form-control" placeholder="Text" value=<?php echo $preSignTime;?>>
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="normalPrice" class="form-control" placeholder="Text" value=<?php echo $normalPrice;?>>
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="weekPrice" class="form-control" placeholder="Text" value=<?php echo $weekPrice;?>>
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">路考价格</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="lukaoPrice" class="form-control" placeholder="Text" value=<?php echo $lukaoPrice;?>>
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="cancelTimeMax" class="form-control" placeholder="Text" value=<?php echo $cancelTimeMax;?>>
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
