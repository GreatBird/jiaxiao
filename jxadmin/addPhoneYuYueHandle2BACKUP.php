...
$name=$_POST['name'];
$cityID=$_POST['cityID'];
$yuYueType=intval($_POST['yuYueType']);
			    ...
			    <div class="col-lg-12">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>添加预约</strong></h2>
			            </div>
						<div class="panel-body">
							<form action="addPhoneYuYueTH1.php" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                <input type="hidden" name="yuYueType" value=<?php echo $yuYueType;?>>
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="disabled-input">学员姓名</label>
				                    <div class="col-md-9">
				                        <input type="text" id="disabled-input" name="studentName" class="form-control" placeholder="Disabled" value=<?php echo $name;?>>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="disabled-input">学员身份证号</label>
				                    <div class="col-md-9">
				                        <input type="text" id="disabled-input" name="cityID" class="form-control" placeholder="Disabled" value=<?php echo $cityID;?>>
				                    </div>
				                </div>
								...
								<div class="form-group">
				                    <label class="col-md-3 control-label" for="select">选择可预约日期</label>
				                    <div class="col-md-9">
				                        <select id="select" name="beginDate" class="form-control input-lg" size="1">
...
for ($i=0; $i < 5; $i++) { 
	...
	echo "<option value=\"".date('m-d',strtotime("+$i day"))."\">".date('m-d',strtotime("+$i day"))."</option>";
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="select">预约时间段</label>
				                    <div class="col-md-9">
				                        <select id="select" name="yuYueTime" class="form-control input-lg" size="1">
										    ...
										    if ($result) {
										             while($row = mysqli_fetch_array($result))
										                { 
										                    ...
										                    echo " <option value=\"".$beginTime."--".$endTime."\">".$beginTime."--".$endTime."</option>";
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="select">教练姓名</label>
				                    <div class="col-md-9">
				                        <select id="select" name="teacherName" class="form-control input-lg" size="1">
								            ...
								            $sql="SELECT * from teacher where lukaoStatus='$yuYueType'";
								            $name="";
								            $teacherID="";
				                ...
				                <!-- <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <div class="radio">
				                            <label for="radio1">
				                            <input type="radio" id="radio1" name="yuYueType" value="1"> 路考预约
				                            </label>
				                        </div>
				                        <div class="radio">
				                            <label for="radio2">
				                            <input type="radio" id="radio2" name="yuYueType" value="0"> 项训预约
				                            </label>
				                        </div>
