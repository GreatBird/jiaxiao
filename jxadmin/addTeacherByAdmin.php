			    ...
			    <div class="col-lg-12">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>添加教练（以下都是必填项目）</strong></h2>
			            </div>
						<div class="panel-body">
							<form action="addTeacherTemp.php" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="username" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">教练编号</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="teacherID" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
