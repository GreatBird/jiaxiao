			    ...
			    <div class="col-lg-12">
			        <div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="addPhoneYuYueHandle2.php" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <div class="radio">
				                            <label for="radio1">
				                            <input type="radio" id="radio1" name="yuYueType" value="1"> 路训预约
				                            </label>
				                        </div>
				                        <div class="radio">
				                            <label for="radio2">
