			    ...
			    <div class="col-lg-12">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>添加电话预约（以下都是必填项目）</strong></h2>
			            </div>
						<div class="panel-body">
							<form action="addPhoneYuYueHandle1.php" method="post" enctype="multipart/form-data" class="form-horizontal ">
								<input type="hidden" name="phoneYuYue" value="1">
				                ...
				                <!-- <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="studentName" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">学员手机号</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="studentPhone" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">教练姓名</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="teacherName" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">教练手机号</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="teacherPhone" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">预约日期</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="beginDate" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="beginTime" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div> -->

				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">学员号</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="studentID" class="form-control" placeholder="Text">
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
