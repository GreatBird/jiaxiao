			    ...
			    <div class="col-lg-12">
			        <div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="addSchedule1.php" method="post" enctype="multipart/form-data" class="form-horizontal ">
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="select">选择月份</label>
				                    <div class="col-md-9">
...
<div class="form-group">
				                    <label class="col-md-3 control-label" for="select">上午开始时间</label>
				                    <div class="col-md-9">
				                        <select id="select" name="morningBegin" class="form-control input-lg" size="1">
				                        	<option>04:00</option>
							                  <option>05:00</option>
							                  <option>06:00</option>
							                  <option>07:00</option>
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="select">上午结束时间</label>
				                    <div class="col-md-9">
				                        <select id="select" name="morningEnd" class="form-control input-lg" size="1">
				                        	<option>04:00</option>
							                  <option>05:00</option>
							                  <option>06:00</option>
							                  <option>07:00</option>
...
<div class="form-group">
				                    <label class="col-md-3 control-label" for="select">下午开始时间</label>
				                    <div class="col-md-9">
				                        <select id="select" name="afterBegin" class="form-control input-lg" size="1">
				                            <!-- <option>08:00</option>
							                  <option>09:00</option>
							                  <option>10:00</option>
							                  <option>11:00</option> -->
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="select">下午结束时间</label>
				                    <div class="col-md-9">
				                        <select id="select" name="afterEnd" class="form-control input-lg" size="1">
				                            <!-- <option>08:00</option>
							                  <option>09:00</option>
							                  <option>10:00</option>
							                  <option>11:00</option> -->
