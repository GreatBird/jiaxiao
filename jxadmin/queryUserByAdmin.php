        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h2><i class="fa fa-table red"></i><span class="break"></span><strong>查看所有学员</strong></h2>
...
echo " <tr >";
                  ...
                  if ($xiangStatus==0) {
                    echo "<td><a href=\"updateYuYueStatus.php?id=$id&type=xiang\">".'点击开通项训预约'."</a></td>";
                  }
                  ...
                  if ($luStatus==0) {
                    echo "<td><a href=\"updateYuYueStatus.php?id=$id&type=lu\">".'点击开通路训预约'."</a></td>";
                  }
