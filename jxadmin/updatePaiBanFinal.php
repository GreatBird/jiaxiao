			    ...
			    <div class="col-lg-12">
			        <div class="panel panel-default">
			            <div class="panel-heading">
			                <h2><i class="fa fa-indent red"></i><strong>更改排班配置</strong></h2>
			            </div>
						<div class="panel-body">
							<form action="../updatePaiBan.php" method="post" enctype="multipart/form-data" class="form-horizontal ">

								<input type="hidden" name="id" value=<?php echo $id;?>>
				                <div class="form-group">
				                    <label class="col-md-3 control-label">教练姓名</label>
				                    <div class="col-md-9">
				                        <p class="form-control-static"><?php echo $teacherName;?></p>
				                    </div>
				                </div>
<div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">排班月份</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="month" class="form-control" placeholder="Text" value=<?php echo $month;?>>
				                ...
				                <div class="form-group">
				                    <label class="col-md-3 control-label" for="text-input">排班日期</label>
				                    <div class="col-md-9">
				                        <input type="text" id="text-input" name="paibanDate" class="form-control" placeholder="Text" value=<?php echo $paibanDate;?>>
				                        <span class="help-block"> </span>
				                    </div>
				                </div>
