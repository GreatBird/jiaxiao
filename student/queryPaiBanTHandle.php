...
$today=date("m-d",strtotime("+0 day"));
...
<!--     <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Grid Layout</a> </div>
 -->    <h1>查看<?php echo $teacherName."教练的排班";?></h1>
  </div>
  ...
  <?php 
                            ...
                            $sql="SELECT * from paiban where  lukaoRenShu<2 and bukeyuyue!=1 and lukaoStatus= '$lukaoStatusTemp' and( (teacherName='$teacherName' and ( month='$month' and paibanDate >= '$day' )) or (teacherName='$teacherName' and month > '$month'))";
                            // echo "sql is".$sql;
