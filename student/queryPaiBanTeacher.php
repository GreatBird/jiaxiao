    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="queryPaiBanTHandle.php" method="post" class="form-horizontal">
              ...
              <div class="controls">
                ...
                <select id="select" name="teacherName" class="form-control input-lg" size="1">
                  ...
                  <?php 
                            ...
                            include '../conn.php';
                            if ($type=='lukao') {
                              $sql="SELECT distinct(teacherName) from paiban where lukaoStatus=1 ";
                              # code...
                            }else{
                              $sql="SELECT distinct(teacherName) from paiban where lukaoStatus=0";
